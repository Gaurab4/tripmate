    ...
    <div className="flex min-h-[calc(100vh-60px)] items-center justify-center px-6 py-8">
      <div className="mx-auto w-full max-w-[480px]">
        <div className="card-surface animate-scale-in mx-auto max-w-[380px] p-8">
          <h1 className="mb-5 text-center text-xl font-semibold text-app-text">Create account</h1>
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <label className="block">
              <span className="mb-1.5 block text-sm font-medium text-text-soft">Email (optional)</span>
              <input
                id="email"
                type="email"
                value={email}
